...
class CRUDScheduleblock(
    ...
    def create_day_by_user_id(
        self, db: Session, table_id: str, user_id: str, day: int
    ) -> List[ScheduleBlock]:
        db_objs = [
            ScheduleBlock(
                id=create_uuid(),
    ...
    def create_time_by_user_id(
        self, db: Session, table_id: str, user_id: str, start_time: int
    ) -> List[ScheduleBlock]:
        db_objs = [
            ScheduleBlock(
                id=create_uuid(),
